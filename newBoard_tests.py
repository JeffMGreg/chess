...
class TestBishopMoves(TestCase):
    ...
    def test_bishop_moves(self):
        self.b.set("c1", Bishop("c1", "w", "q"))

        trace()
        self.assertEqual(self.b.c1.move("e3"), (True, "normal", None))



        self.assertEqual(self.b.e3.move("c5"), (True, "normal", None))
        self.assertEqual(self.b.c5.move("e3"), (True, "normal", None))
        self.assertEqual(self.b.e3.move("c1"), (True, "normal", None))

        self.b.set("c1", Bishop("c1", "b", "q"))
        self.assertEqual(self.b.c1.move("e3"), (True, "normal", None))
        self.assertEqual(self.b.e3.move("c5"), (True, "normal", None))
        self.assertEqual(self.b.c5.move("e3"), (True, "normal", None))
        self.assertEqual(self.b.e3.move("c1"), (True, "normal", None))
    ...
    #~ def test_bishop_attacks(self):
        #~ self.b.c1.piece = Bishop("c1", "w", "q")
        #~ self.b.e3.piece = Rook("e3", "w", "k")
        #~ self.assertEqual(self.b.c1.move("e3"), (False, "", None))
        #~ self.b.e3.piece = Rook("e3", "b", "k")
        #~ self.assertEqual(self.b.c1.move("e3"), (True, "normal", None))
